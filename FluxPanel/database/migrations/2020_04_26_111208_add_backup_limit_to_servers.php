...
class AddBackupLimitToServers extends Migration
{
    ...
    public function up(): void
    {
        ...
        $results = DB::connection()->getDriverName() === 'sqlite'
            ? (Schema::hasColumn('servers', 'backup_limit') ? [true] : [])
            : DB::select('SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = ? AND TABLE_NAME = \'servers\' AND COLUMN_NAME = \'backup_limit\'', [
