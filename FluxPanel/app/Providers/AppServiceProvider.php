...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Relation::enforceMorphMap([
            ...
            'server_managed_plugin' => Models\ServerManagedPlugin::class,
            'server_optimizer_finding' => Models\ServerOptimizerFinding::class,
            'server_optimizer_run' => Models\ServerOptimizerRun::class,
            'server_optimizer_snapshot' => Models\ServerOptimizerSnapshot::class,
